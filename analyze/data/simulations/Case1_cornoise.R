...
case1_0.05_wide <- read_csv("Code/data/kde/summary/case1_0.05_wide.csv")
case1_0.1_wide <- read_csv("Code/data/kde/summary/case1_0.1_wide.csv")
case1_0.15_wide <- read_csv("Code/data/kde/summary/case1_0.15_wide.csv")
case1_0.2_wide <- read_csv("Code/data/kde/summary/case1_0.2_wide.csv")

ptip_df <- read_csv("data/kde/case1_ptip.csv")
...
plt5 <- ptip_df %>% ggplot() + aes(x = cor, y = (ptip - baseline)/baseline*100, color = as.factor(sigma)) +
