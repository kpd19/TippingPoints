...
case1_sim <- read_csv("data/simulationskde_case1_sim_0.0_N2.csv")
case1_time <- read_csv("data/simulations/kde_case1_sim_0.0_t.csv")
case1_gamma <- read_csv("data/simulationskde_case1_sim_0.0_d.csv")
...
pdf("figures/kde/case1_ts_10k_coex2.pdf", height = 6, width = 12)
plt1 <- case1_sim %>% ggplot() + geom_line(aes(x = time/10000, y = Competitor, color = "Competitor")) + 
...
plt2 <- case1_sim %>% filter(time >= 480*10000, time <= 600*10000) %>% 
